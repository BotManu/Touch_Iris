/**
 * @file lv_touch_iris_widgets_shop.c
 *
 */
...
void lv_touch_iris_widgets_shop_create(lv_obj_t * parent)
{
    ...
    lv_obj_t * title = lv_touch_iris_widgets_title_create(panel1, "Monthly Summary");

    lv_obj_t * date = lv_touch_iris_widgets_title_create(panel1, "8-15 July, 2021");
    lv_obj_add_style(date, &style_text_muted, 0);

    lv_obj_t * amount = lv_touch_iris_widgets_title_create(panel1, "$27,123.25");
    ...
    title = lv_touch_iris_widgets_title_create(list, "Top products");
    ...
    title = lv_touch_iris_widgets_title_create(notifications, "Notification");
