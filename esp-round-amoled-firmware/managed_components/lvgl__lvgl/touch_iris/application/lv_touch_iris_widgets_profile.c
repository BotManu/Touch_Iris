/**
 * @file lv_touch_iris_widgets_profile.c
 *
 */
...
void lv_touch_iris_widgets_profile_create(lv_obj_t * parent)
{

    lv_obj_t * panel1 = lv_obj_create(parent);
    lv_obj_set_height(panel1, LV_SIZE_CONTENT);

    LV_IMAGE_DECLARE(img_touch_iris_widgets_avatar);
    lv_obj_t * avatar = lv_image_create(panel1);
    lv_image_set_src(avatar, &img_touch_iris_widgets_avatar);

    lv_obj_t * name = lv_touch_iris_widgets_title_create(panel1, "Emanuel");
    ...
    lv_obj_t * panel2_title = lv_touch_iris_widgets_title_create(panel2, "Your profile");
    ...
    lv_obj_t * panel3_title = lv_touch_iris_widgets_title_create(panel3, "Your skills");
