/**
 * @file lv_touch_iris_widgets_analytics.c
 *
 */
...
void lv_touch_iris_widgets_analytics_create(lv_obj_t * parent)
{
    ...
    LV_IMAGE_DECLARE(img_touch_iris_widgets_needle);
    scale3_needle = lv_image_create(scale3);
    lv_image_set_src(scale3_needle, &img_touch_iris_widgets_needle);
    lv_image_set_pivot(scale3_needle, 3, 4);
    lv_obj_align(scale3_needle, LV_ALIGN_CENTER, 47, -2);

    scale3_mbps_label = lv_touch_iris_widgets_title_create(scale3, "-");
                                   ...
                                   const char * text3)
{
    ...
    lv_obj_t * title_label = lv_touch_iris_widgets_title_create(cont, title);
...
static lv_obj_t * create_chart_with_scales(lv_obj_t * parent, const char * title,  const char * hor_text[])
{
    ...
    lv_obj_t * label = lv_touch_iris_widgets_title_create(parent, title);
